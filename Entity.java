...
public abstract class Entity {
    ...
    public boolean isCollidingWith(Entity other){
        if (isCollidingWith(other.getX(), other.getY())) return true;
        if (isCollidingWith(other.getX()+other.getWidth(), other.getY())) return true;
        if (isCollidingWith(other.getX(), other.getY()+other.getHeight())) return true;
        if (isCollidingWith(other.getX()+other.getWidth(), other.getY()+other.getHeight())) return true;
        return false;
    }
