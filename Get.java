...
public class Get extends Entity implements Collectable, Scrollable {
    ...
    public static final String GET_IMAGE_FILE = "assets/basketball.png";
    //Dimensions of the Get  
    public static final int GET_WIDTH = 45;
    public static final int GET_HEIGHT = 45;
    ...
    public static final int GET_POINT_VALUE = 2;
